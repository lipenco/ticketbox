...
(function() {
  ...
  this.TB.module("PictureApp.New", function(New, App, Backbone, Marionette, $, _) {
    ...
    New.TakenPicture = (function(_super) {
      __extends(TakenPicture, _super);
      ...
      function TakenPicture() {
        ...
        return TakenPicture.__super__.constructor.apply(this, arguments);
      }

      TakenPicture.prototype.template = "picture/new/_takenpicture";

      TakenPicture.prototype.tagName = "li";

      TakenPicture.prototype.className = "col-md-12";

      TakenPicture.prototype.events = {
        "mouseover .wrapper": "showIcons",
        "mouseleave .wrapper": "showHide",
        "click .pic-trash": "deletePicture"
      };

      TakenPicture.prototype.showIcons = function(e) {
        return this.$el.find(".icons-hover").addClass("visible");
      };

      TakenPicture.prototype.showHide = function(e) {
        return this.$el.find(".icons-hover").removeClass("visible");
      };

      TakenPicture.prototype.deletePicture = function(e) {
        return this.$el.hide();
      };

      TakenPicture.prototype.triggers = {
...
(function() { this.JST || (this.JST = {}); this.JST["backbone/apps/ticket/preview/templates/_description"] = function(__obj) {
    ...
    (function() {
      (function() {
        __out.push('<section class="contents description-section">\n  <p class="deslegend">I will remember most:</p>\n    <input type="text" id="description-input" placeholder="Write your impressionss here"></input>\n</section>\n');
...
(function() { this.JST || (this.JST = {}); this.JST["backbone/apps/ticket/preview/templates/_empty"] = function(__obj) {
    ...
    (function() {
      (function() {
        __out.push('<li><img class="tickett" src="/assets/prew.png"></li>\n');
